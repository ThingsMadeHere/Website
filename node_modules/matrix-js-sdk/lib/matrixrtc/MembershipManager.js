 ...
 * @internal
 */
export let MembershipActionType = /*#__PURE__*/function (MembershipActionType) {
...
export class MembershipManager extends TypedEventEmitter {
  ...
  get networkErrorRetryMs() {
    return this.joinConfig?.networkErrorRetryMs ?? 3000;
  }
  ...
  get membershipEventExpiryHeadroomMs() {
    return this.joinConfig?.membershipEventExpiryHeadroomMs ?? 5000;
  }
  ...
  get delayedLeaveEventDelayMs() {
    return this.delayedLeaveEventDelayMsOverride ?? this.joinConfig?.delayedLeaveEventDelayMs ?? 8000;
  }
  get delayedLeaveEventRestartMs() {
    return this.joinConfig?.delayedLeaveEventRestartMs ?? 5000;
  }
