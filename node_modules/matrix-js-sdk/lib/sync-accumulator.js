...
export let Category = /*#__PURE__*/function (Category) {
...
export class SyncAccumulator {
  ...
  accumulateJoinState(roomId, data, fromDatabase = false) {
    ...
    currentData._unreadThreadNotifications = data[UNREAD_THREAD_NOTIFICATIONS.stable] ?? data[UNREAD_THREAD_NOTIFICATIONS.unstable] ?? undefined;
    if (data.summary) {
