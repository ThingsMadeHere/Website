...
export let RelationsEvent = /*#__PURE__*/function (RelationsEvent) {
...
export class Relations extends TypedEventEmitter {
  ...
  async getLastReplacement() {
    ...
    if (lastReplacement?.shouldAttemptDecryption() && this.client.getCrypto()) {
      ...
      await lastReplacement.attemptDecryption(this.client.getCrypto());
   ...
   */
  async updateTargetEventReplacement() {
