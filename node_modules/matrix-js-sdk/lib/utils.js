 ...
 */
export async function logDuration(logger, name, block) {
...
export async function promiseMapSeries(promises, fn // if async we don't care about the type as we only await resolution
) {
...
export async function chunkPromises(fns, chunkSize) {
  const results = [];
 ...
 */
export function alphabetPad(s, n, alphabet = DEFAULT_ALPHABET) {
 ...
 */
export function baseToString(n, alphabet = DEFAULT_ALPHABET) {
 ...
 */
export function stringToBase(s, alphabet = DEFAULT_ALPHABET) {
  const len = BigInt(alphabet.length);
 ...
 */
export function averageBetweenStrings(a, b, alphabet = DEFAULT_ALPHABET) {
 ...
 */
export function nextString(s, alphabet = DEFAULT_ALPHABET) {
 ...
 */
export function prevString(s, alphabet = DEFAULT_ALPHABET) {
  return baseToString(stringToBase(s, alphabet) - BigInt(1), alphabet);
}
 ...
 */
export function recursivelyAssign(target, source, ignoreNullish = false) {
 ...
 */
export function mapsEqual(x, y, eq = (v1, v2) => v1 === v2) {
