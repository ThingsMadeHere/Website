...
import { IRtcTransportsFromWidgetResponseData } from "./interfaces/RtcTransportsAction";
...
import { IRtcLivekitDelegateDelayedLeaveFromWidgetRequestData, IRtcLivekitDelegateDelayedLeaveFromWidgetResponseData, IRtcLivekitGetTokenFromWidgetRequestData, IRtcLivekitGetTokenFromWidgetResponseData } from "./interfaces/RtcLivekitActions";
...
export declare class WidgetApi extends EventEmitter {
     ...
     */
    requestCapabilityToGetRtcLivekitToken(): void;
    /**
     ...
     * @see {@link https://github.com/matrix-org/matrix-spec-proposals/pull/4533|MSC4533}
     */
    requestCapabilityToDelegateRtcLivekitDelayedLeave(): void;
    /**
    ...
    sendRoomEvent(eventType: string, content: unknown, roomId?: string, delay?: number, stickyDurationMs?: number): Promise<ISendEventFromWidgetResponseData>;
    /**
    ...
    sendStateEvent(eventType: string, stateKey: string, content: unknown, roomId?: string, delay?: number): Promise<ISendEventFromWidgetResponseData>;
    /**
     * @deprecated Use the overload of this function without {@link parentDelayId} instead.
     */
     ...
     */
    getRtcTransports(): Promise<IRtcTransportsFromWidgetResponseData>;
    /**
